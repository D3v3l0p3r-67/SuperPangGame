...
import {
  ...
  BEAM_HIT_TEXTURE_KEY, BEAM_HIT_TEXTURE_PATH, BEAM_HIT_SIZE,
...
export class BootScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.spritesheet(BEAM_HIT_TEXTURE_KEY, BEAM_HIT_TEXTURE_PATH, { frameWidth: BEAM_HIT_SIZE, frameHeight: BEAM_HIT_SIZE });
